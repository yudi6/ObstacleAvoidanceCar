...
class ObstacleAvoidanceCar():
    def __init__(self):
        ...
        # self._motor(1)
        # PID控制
        self.PID_control = PID(0.15,0.0,0.02)
    ...
    def _run(self):
        ...
        while True:
            ...
            if temp_p < 0.05:
                ...
                self._steer(3,0)
                speed_now = 3
            elif temp_p > 0.3 or (abs(error_before - direction) > 100 and len(contours) != 1):
                print('2')
                self._steer(10,0)
                speed_now = 10
            else:
